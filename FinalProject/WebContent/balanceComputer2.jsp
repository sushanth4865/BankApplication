...
String acct = session.getAttribute("signedIn").toString();
...
else if(transtype.equals("minus")){	
...
out.print("Something incorrect please go back"+"<br><a href='transaction'><button>Go Back</button></a>");
}
...
if(transtype.equals("add")){
st.executeUpdate("INSERT INTO `transactions`(`number`, `date`, `description`, `chagenum`, `withdrawamt`, `depositmt`, `availablebal`, `userid`) VALUES (null,'"+date+"','debit','300','"+tmt+"',null,'"+amtInt+"','"+acct2+"')");
out.println("Account Number:"+accountNumber);
out.println("Debited:"+amtInt);
out.println("<br/>");
out.println("Account Number:"+session.getAttribute("acct").toString());
out.println("Credited:"+amtInt);
out.println("<br/>");
out.println("<a href='dashboard.jsp'>Return to Dashboard</a>");
}
else if(transtype.equals("minus")){
st.executeUpdate("INSERT INTO `transactions`(`number`, `date`, `description`, `chagenum`, `withdrawamt`, `depositmt`, `availablebal`, `userid`) VALUES (null,'"+date+"','credit','400',null,'"+tmt+"','"+amtInt+"','"+acct2+"')");
out.println("Account Number:"+accountNumber);
out.println("Credited:"+amtInt);
out.println("<br/>");
out.println("Account Number:"+session.getAttribute("acct").toString());
